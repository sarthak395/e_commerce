...
export default function Home() {
  return (
    <div className='flex flex-col min-h-screen'>
      <Head>
        <title>PeHnoDabaKe - Nange thodi Ghumoge !! </title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className="bg-indigo-50 items-center">
        <Image className='relative h-full w-full' src='/home.png' width={1500} height={600}></Image>
      </div>

      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Chalo shopping kare</h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">welcome to the largest e-commerce website in the world with over 100000000+ customers worldwide . One stop destination for your cardigans</p>
          </div>

  ...
  return (
    <header className="text-gray-600 body-font shadow-xl my-3 top-0 sticky bg-white z-10" >
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center ">
        ...
        <Link href={"/login"} className='mr-7'><IoIosContact size={40}/></Link>
        <button onClick={togglecart} className="cursor-pointer inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Cart
